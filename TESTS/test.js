...
toggleButton.addEventListener("click", function() {
  ...
  if (this.textContent === "OFF") {
    ...
    var Killalerts = ["Securly passed from old age. RIP Securly, 2012-2023", "Securly couldn't take the stress.", "Securly Succesfully Killed", "Securly unfortunately slept with the fish."];
var randomIndex = Math.floor(Math.random() * Killalerts.length);
var randomAlert = Killalerts[randomIndex];
alert(randomAlert);;
  } else {
    const o = 32 * 1;
    const t = new Date(2e14).toUTCString();
